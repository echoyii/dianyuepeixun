...
<header data-blend-widget="header" class="blend-header header_title_bg">
    <span class="blend-header-left">
        <a class="blend-header-item  blend-button" href="<?php echo U('M/Founding/detail',array('fdid' => $fd_info['id'],'specialid'=>$specialid));?>"><img src="<?php echo ($resource_basic); ?>/img/btn_back.png" style="height:28px;"/></a>
        </span>
   ...
   <figure class="blend-picture blend-picture-full" >
        <img src='<?php echo ($resource_basic); ?>/special/special_donate_share1.jpg' />
        <img src='<?php echo ($resource_basic); ?>/special/special_donate_share2.jpg' />
        <img src='<?php echo ($resource_basic); ?>/special/special_donate_share3.jpg' />
    </figure>
