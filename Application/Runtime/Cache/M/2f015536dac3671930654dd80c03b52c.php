...
//                                    window.location.href = "<?php echo U('M/Index/index');?>";
                                    window.location.href = "<?php echo U('M/Founding/donate_ok_to_share',array('fdid'=>$fd_info['id']));?>";
                                    //支付成功的反馈
                                }else
                                {
                                    alert('支付取消');
                                    
                                    window.location.href = "<?php echo U('M/Founding/detail',array('fdid'=>$fd_info['id']));?>";
                                }
