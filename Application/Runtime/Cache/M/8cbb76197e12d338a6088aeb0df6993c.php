...
<header data-blend-widget="header" class="blend-header header_title_bg">
    <span class="blend-header-left">
        <a class="blend-header-item  blend-button" href="<?php echo U('M/Founding/lists',array('state'=>1));?>"><img src="<?php echo ($resource_basic); ?>/img/btn_back.png" style="height:28px;"/></a>
        </span>
    ...
    <div id="blendForm1" class="blend-form" style="margin: 8px 0;">
        ...
        <div class="blend-formgroup">
            ...
            <label class="list_right_content"><?php echo ($fd_info["location"]); ?></label>
        </div>
        <div class="blend-formgroup ">
    ...
    <?php if(($fd_info["state"] == 1) OR ($fd_info["state"] == 0)): ?><div class="footer_nav">
            <a class="blend-button blend-button-primary blend-button-large" href="<?php echo U('M/Founding/donate_pay_money',array('fdid'=>$fdid));?>">立即支持</a>
        </div><?php endif; ?>
