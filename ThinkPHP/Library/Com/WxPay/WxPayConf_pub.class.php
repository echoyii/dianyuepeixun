...
class WxPayConf_pub
{
	...
	const APPID = 'wxd7001177ec6e2adf';
        const APPID_OPEN = 'wxd7001177ec6e2adf';
//        const APPID_OPEN = 'wx992a712e55c41b92';
	//受理商ID，身份标识
	const MCHID = '1275252201';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'zhongcetianxiazhongcetianxia2015';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = '46a92d49504117fecf843ad9ebf3bc01';
        const APPSECRET_OPEN = '46a92d49504117fecf843ad9ebf3bc01';
